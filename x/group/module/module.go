...
import (
	...
	"github.com/vishal-kanna/group/x/group/client/cli"
	"github.com/vishal-kanna/group/x/group/keeper"
	"github.com/vishal-kanna/group/x/group/simulation"
...
func (AppModuleBasic) RegisterRESTRoutes(sdkclient.Context, *mux.Router) {
	panic("unimplemented")
}
