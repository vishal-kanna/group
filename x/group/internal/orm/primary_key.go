...
// AddAfterDeleteInterceptor implements Indexable.
func (*PrimaryKeyTable) AddAfterDeleteInterceptor(interceptor AfterDeleteInterceptor) {
	panic("unimplemented")
}

// AddAfterSetInterceptor implements Indexable.
func (*PrimaryKeyTable) AddAfterSetInterceptor(interceptor AfterSetInterceptor) {
	panic("unimplemented")
}

// RowGetter implements Indexable.
func (*PrimaryKeyTable) RowGetter() RowGetter {
	panic("unimplemented")
}
